...
1. 会議の開催は、ZOOM のHP にて「ミーティング」タブで登録。ZOOM アプリの「スケジュール」でも登録できるが、何分前から「参加者に参加を許可する」のかを設定できないので非推奨。  
...
8. オプション：「ホストより先に参加することを参加者に許可：オン」「Participants can join：開始時間の5分前」で、開始5分前から、ホストがログインしていなくても、参加者は参加できる。
